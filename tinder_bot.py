...
fb_email.send_keys("EMAIL") #Type your email/tinder id here

time.sleep(2)

fb_pass = url.find_element(By.XPATH, '//*[@id="pass"]')
fb_pass.send_keys("PASSWORD") #Type your password here
...
try:
    ...
    time.sleep(10)
    continue_button = url.find_element(By.XPATH,
                                       '/html/body/div[1]/div/div/div/div/div/div/div[1]/div[3]/div/div/div/div/div/div/div[2]/div/div/div[1]/div/div/div/div[1]/div/div/div/div/div/div[1]/div/span/span')
    continue_button.click()
